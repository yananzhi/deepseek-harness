...
describe('hand-declared providers', () => {
  ...
  it('scopes each card to fields a provider can actually own', async () => {
    ...
    expect(fields()).toEqual([en.customRoute, en.customDisplayName, en.baseUrl, en.proxyUrl, en.customApi, en.keyInput])
    cleanup()
    ...
    expect(fields()).toEqual([en.keyInput, en.baseUrl, en.proxyUrl])
    cleanup()
    ...
    expect(fields()).toEqual([en.keyInput, en.customDisplayName, en.baseUrl, en.proxyUrl, en.customApi])
  })
